...
const SaltyVoiceButton: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-32 md:bottom-28 right-6 md:right-12 z-[3000000] flex flex-col items-center gap-6 pointer-events-auto scale-90 md:scale-100 origin-right transition-all duration-300">
