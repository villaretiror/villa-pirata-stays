...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-secondary py-20 px-6 border-t border-primary/10">
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center space-y-12">
        {/* VRR Signature Icon */}
        <div className="flex flex-col items-center space-y-4">
          <div className="w-16 h-16 rounded-full border border-primary/30 flex items-center justify-center bg-white/5 backdrop-blur-md shadow-2xl">
             <span className="font-serif italic font-black text-2xl text-primary">VRR</span>
          </div>
          <div>
            <h3 className="font-serif font-black text-2xl text-white tracking-tighter">Villa Retiro R</h3>
            <p className="text-[10px] uppercase font-black tracking-[0.4em] text-primary mt-1 opacity-70">Cabo Rojo · Puerto Rico</p>
          </div>
        </div>
