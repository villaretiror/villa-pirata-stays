...
import { ViewState, Property, LocalGuideCategory, LocalGuideItem, Offer, CalendarSync, Review, User } from '../types';
...
const HostDashboard: React.FC = () => {
  ...
  const handleImport = async (url: string) => {
    ...
    const newProperty: Property = {
      ...
      blockedDates: [],
      calendarSync: [],
      host: properties[0].host // Use same host info
    };
  ...
  return (
    <div className="bg-sand min-h-screen pb-24 font-display text-text-main">
      ...
      <main className="px-6 mt-4">
        ...
        {activeTab === 'menu' && <HostMenu properties={properties} />}
