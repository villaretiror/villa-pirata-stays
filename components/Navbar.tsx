...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-4 pb-[env(safe-area-inset-bottom,12px)] left-0 right-0 z-50 flex justify-center pointer-events-none animate-slide-up">
      <ul className="pointer-events-auto bg-white/95 backdrop-blur-xl border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.08)] rounded-[2rem] px-6 py-2.5 flex items-center justify-between w-[90%] max-w-[360px] m-0 list-none">
        ...
        <li><NavItem path="/profile" icon="person" label="Perfil" /></li>
      </ul>
    </nav>
  );
};
