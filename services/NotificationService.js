 ...
 * Token: 8612052249:AAEFr5Gh2JIBEbc3Xp4o91-lhUl3aZPZbdQ
 */

export const NotificationService = {
    /**
     * Envía una alerta a Telegram al chat del Host.
     * @param {string} message Mensaje formateado para Telegram (HTML)
     */
    async sendTelegramAlert(message) {
        // En un entorno de producción, el TOKEN y el CHAT_ID vendrían de variables de entorno (process.env)
