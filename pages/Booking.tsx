      ...
      <div className="bg-white w-full max-w-md h-[95vh] sm:h-auto sm:rounded-[2.5rem] rounded-t-[2.5rem] overflow-hidden flex flex-col shadow-2xl animate-slide-up">
        ...
        <div className="p-6 bg-white border-t border-gray-100">
          <button 
            ...
            className="w-full bg-primary text-white font-bold py-4 rounded-2xl shadow-float hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
          >
            {paymentMethod === 'ath_movil' ? 'PAGAR CON ATH MÓVIL' : 'CONFIRMAR RESERVA'}
